    ...
    <div v-if="grid" class="group relative h-80 w-64 perspective-[1000px]">
        ...
        >
            ...
            >
                ...
                <div class="mt-auto h-1.5 w-full rounded-full overflow-hidden bg-bg-main border border-border-light/50">
                    <div
            ...
            >
                ...
                <p class="text-sm font-bold text-text-main mb-4 truncate w-full">{{ candidate.telephone }}</p>
